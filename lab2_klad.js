...
// Функция для получения границ компонента (Bounding Box)
function getBoundingBox(c, w, imgWidth, imgHeight) {
    ...
    const padding = 5; // Отступ рамки от краев объекта
    return {
